...
import com.caryatri.caryatri.adapter.RefundAdapter;
...
public class CancelCabActivity extends CrashActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cancel_cab);
                ...
                if (Common.currentUser == null) {
                    ...
                    mService.getUserInfo(email, password).enqueue(new Callback<User>() {
                        ...
                        public void onFailure(Call<User> call, Throwable t) {
                            ...
                            Toast.makeText(CancelCabActivity.this, "Try Again", Toast.LENGTH_SHORT).show();
                        }
                    });
                } else {
                    loadTrip();
    ...
    private void loadTrip() {
        compositeDisposable.add(mService.getCancelCab(0, Common.currentUser.getPhone())
                ...
                .subscribe(new Consumer<List<Trip>>() {
                    ...
                    public void accept(List<Trip> trips) throws Exception {
                        swipeRefreshLayout.setRefreshing(false);
                        RefundAdapter refundAdapter = new RefundAdapter(CancelCabActivity.this, trips, getSupportFragmentManager());
